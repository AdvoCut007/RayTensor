...
class RayTensor:
    def __init__(self):
        ...
        self.xray_class_names = ["COVID19", "NORMAL", "PNEUMONIA", "TURBERCULOSIS"]
        self.ct_class_names = ["COVID", "NORMAL", "PNEUMONIA"]
    ...
    def xray_predict(self, path_to_image):
        ...
        img = tf.keras.utils.load_img(
            path_to_image, target_size=(self.img_height, self.img_width)
        )
